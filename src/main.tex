...
\begin{todo}
  Number of references is capped at 12.  We currently have more than that.  Need to cut some citations.
\end{todo}
...
\section{From Optimal Learning to Optimal Control}
\label{sec:framework}
\input{overview}

\section{Optimal Learning}% {Learning Models of Smart Energy Systems}
\label{sec:modeling}
\input{modeling}

\section{Optimal Control} %{Learning-based Control Smart Energy Systems}
\label{sec:control}
\input{control}
